...
const Player:React.FC<{isMobile:boolean}> = ({ isMobile }) => (
  <div className="w-full  d-flex justify-center sm:flex-grow flex   mt-3 sm:mt-[0rem] justify-center">
    <div className="sm:w-[60%] w-[80%] max-[380px]:w-[70%] player-bg rounded-[2rem] shadow h-full flex items-center flex-col py-6 relative">
      <div className=" px-[1.5rem]  sm:h-[10rem] h-[12rem] max-[380px]:h-[10rem] sm:w-[15rem] w-[18rem] max-[380px]:w-[14rem] ">
